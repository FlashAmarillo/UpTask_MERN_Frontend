...
const ModalFormularioTarea = () => {
    ...
    // Estado de los inputs del formulario del modal
    ...
    useEffect(() => {
      // si el objeto tarea cambia, llenamos el formulario
      if(tarea?._id) {
        setId(tarea._id);
      ...
      // para el efecto secundario: si no hay nada en tarea deja los imputs vacios
      setId('');
      setNombre('');
      setDescripcion('');
      setPrioridad('');
    ...
    const handleSubmit = async e => {
        ...
        // reiniciamos los campos del formulario una vez finalizada la linea anterior 
        setId('');
        setNombre('');
        setDescripcion('');
        setPrioridad('');
                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    <Dialog.Title as="h3" className="text-2xl text-center leading-6 font-bold text-gray-900">
